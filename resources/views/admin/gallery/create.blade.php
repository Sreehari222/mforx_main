...
<div class="gallery-create-container">
    ...
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('admin.gallery.store') }}" enctype="multipart/form-data" class="gallery-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="role" id="role" value="{{ old('role') }}" class="form-input" required>
                @error('role')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
